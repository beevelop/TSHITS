...
# 2. Deploy from GHCR
docker compose -f oci://ghcr.io/beevelop/crowd:latest --env-file .env up -d

# 3. Check status
docker compose -f oci://ghcr.io/beevelop/crowd:latest --env-file .env ps
```
...
alias dc="docker compose -f oci://ghcr.io/beevelop/crowd:latest --env-file .env"
